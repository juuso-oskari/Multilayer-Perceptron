...
class NeuralNetwork:
    ...
    def train_databatch(self, inputs_matrix, targets_matrix, eta):  # todo get this to work, averaging is checked
...
if __name__ == '__main__':
    ...
    inputs_matrix = [[1, 0], [0, 1], [1, 1], [0, 0]]
    targets_matrix = [[1], [1], [0], [0]]
